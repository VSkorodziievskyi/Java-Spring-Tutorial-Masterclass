...
public class MessageGeneratorImpl implements MessageGenerator {
    ...
    // the following constants represent appropriate keys in messages.properties file, so their names must match
    ...
    private String getMessage(String code, Object... args) { // getting messages by keys from the source(messages.properties)
